...
const pureDropdownMenuModule = await import('../dist/dropdown-menu/index.js');
const blessedDropdownMenuModule = await import('../dist/dropdown-menu/blessed.js');
...
const blessedNavigationListModule = await import('../dist/navigation-list/blessed.js');
...
const pureSidebarLayoutModule = await import('../dist/sidebar-layout/index.js');
const blessedSidebarLayoutModule = await import('../dist/sidebar-layout/blessed.js');
...
const pureCodeViewerModule = await import('../dist/code-viewer/index.js');
const pureCommandOutputModule = await import('../dist/command-output/index.js');
const pureTerminalPaneModule = await import('../dist/terminal-pane/index.js');
const blessedTerminalPaneModule = await import('../dist/terminal-pane/blessed.js');
const pureCountdownModule = await import('../dist/countdown/index.js');
const pureDateInputModule = await import('../dist/date-input/index.js');
const pureDiffViewerModule = await import('../dist/diff-viewer/index.js');
const pureEnvironmentTableModule = await import('../dist/environment-table/index.js');
const pureEventLogModule = await import('../dist/event-log/index.js');
const purePromptDialogModule = await import('../dist/prompt-dialog/index.js');
const blessedPromptDialogModule = await import('../dist/prompt-dialog/blessed.js');
const pureQrCodeModule = await import('../dist/qr-code/index.js');
const pureScheduleModule = await import('../dist/schedule/index.js');
const pureShortcutRecorderModule = await import('../dist/shortcut-recorder/index.js');
const pureStackTraceModule = await import('../dist/stack-trace/index.js');
...
const [passwordFieldEsmSource, passwordFieldCjsSource] = await Promise.all(
  ['../dist/password-field/index.js', '../dist/password-field/index.cjs'].map((path) =>
    readFile(new URL(path, import.meta.url), 'utf8'),
  ),
);
...
const [dropdownMenuEsmSource, dropdownMenuCjsSource] = await Promise.all(
  ['../dist/dropdown-menu/index.js', '../dist/dropdown-menu/index.cjs'].map((path) =>
    readFile(new URL(path, import.meta.url), 'utf8'),
  ),
);
...
const [navigationListEsmSource, navigationListCjsSource] = await Promise.all(
  ['../dist/navigation-list/index.js', '../dist/navigation-list/index.cjs'].map((path) =>
    readFile(new URL(path, import.meta.url), 'utf8'),
  ),
);
...
const [sidebarLayoutEsmSource, sidebarLayoutCjsSource] = await Promise.all(
  ['../dist/sidebar-layout/index.js', '../dist/sidebar-layout/index.cjs'].map((path) =>
    readFile(new URL(path, import.meta.url), 'utf8'),
  ),
);
...
assert.equal(typeof pureDropdownMenuModule.renderDropdownMenu, 'function');
assert.equal(typeof blessedDropdownMenuModule.dropdownMenu, 'function');
...
assert.equal(typeof blessedNavigationListModule.navigationList, 'function');
...
assert.equal(typeof pureSidebarLayoutModule.calculateSidebarLayout, 'function');
assert.equal(typeof blessedSidebarLayoutModule.sidebarLayout, 'function');
...
assert.equal(typeof pureCodeViewerModule.renderCodeViewer, 'function');
assert.equal(typeof pureCommandOutputModule.renderCommandOutput, 'function');
assert.equal(typeof pureTerminalPaneModule.formatTerminalPaneCommand, 'function');
assert.equal(typeof pureTerminalPaneModule.renderTerminalPane, 'function');
assert.equal(typeof blessedTerminalPaneModule.terminalPane, 'function');
assert.equal(typeof pureCountdownModule.renderCountdown, 'function');
assert.equal(typeof pureDateInputModule.renderDateInput, 'function');
assert.equal(typeof pureDateInputModule.parseDateInput, 'function');
assert.equal(typeof pureDiffViewerModule.renderDiffViewer, 'function');
assert.equal(typeof pureEnvironmentTableModule.renderEnvironmentTable, 'function');
assert.equal(typeof pureEventLogModule.renderEventLog, 'function');
assert.equal(typeof purePromptDialogModule.renderPromptDialog, 'function');
assert.equal(typeof blessedPromptDialogModule.promptDialog, 'function');
assert.equal(typeof pureQrCodeModule.renderQrCode, 'function');
assert.equal(typeof pureScheduleModule.renderSchedule, 'function');
assert.equal(typeof pureShortcutRecorderModule.renderShortcutRecorder, 'function');
assert.equal(typeof pureStackTraceModule.renderStackTrace, 'function');
assert.equal(typeof pureTimeInputModule.renderTimeInput, 'function');
...
for (const source of [numberFieldEsmSource, numberFieldCjsSource]) {
  assert.equal(
    source.includes('blessed'),
    false,
...
for (const source of [passwordFieldEsmSource, passwordFieldCjsSource]) {
  assert.equal(
    source.includes('blessed'),
    false,
    'Pure PasswordField entry must not import Blessed.',
  );
}
...
for (const source of [groupedListEsmSource, groupedListCjsSource]) {
  assert.equal(
    source.includes('blessed'),
    false,
...
for (const source of [dropdownMenuEsmSource, dropdownMenuCjsSource]) {
  assert.equal(
    source.includes('blessed'),
    false,
    'Pure DropdownMenu entry must not import Blessed.',
  );
}
...
for (const source of [navigationListEsmSource, navigationListCjsSource]) {
  assert.equal(
    source.includes('blessed'),
    false,
    'Pure NavigationList entry must not import Blessed.',
  );
}
...
for (const source of [sidebarLayoutEsmSource, sidebarLayoutCjsSource]) {
  assert.equal(
    source.includes('blessed'),
    false,
    'Pure SidebarLayout entry must not import Blessed.',
  );
}
